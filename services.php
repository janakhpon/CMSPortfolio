            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                ...
                <div class="media-body">
                  ...
                  <h3 class="heading">Design Testing</h3>
                </div>
              </div>
            </div>
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                ...
                <div class="media-body">
                  <h3 class="heading">Fullstack Development</h3>
                  <h3 class="heading">Application Security</h3>
                  <h3 class="heading">Software Testing</h3>
                  <h3 class="heading">SEO Optimization</h3>
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                ...
                <div class="media-body">
                  ...
                  <h3 class="heading">Backend API</h3>
                  <h3 class="heading">Reusable Library</h3>
                  <h3 class="heading">Code Refactoring</h3>
                </div>
              </div>
            </div>
          </div>
