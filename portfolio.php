          ...
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              ...
              <ul>
                ...
                <li class="active"><a href="portfolio.php"><span><small>04</small>Portfolio</span></a></li>
								<li class="active"><a href="contact.php"><span><small>05</small>Contact</span></a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="colorlib-navbar-brand">
                <a class="colorlib-logo" href="index.html"><span class="logo-img" style="background-image: url(images/person_1.jpg);"></span>Janakh Pon</a>
              </div>
      ...
      <section class="ftco-section">
        <div class="container mt-5">
          ...
          <div class="row no-gutters">
              ...
              <a href="portfolio-single.html" class="image d-flex justify-content-center align-items-center" style="background-image: url('images/work-1.jpg'); "
              ...
              <div class="text">
                ...
                <h2 class="heading"><a href="portfolio-single.html">Python</a></h2>
                <p> My main language is Python as i code it most of the time in topic like web application, GUI
                  application, Machine Learning and Data Science Projects.</p>
            ...
            <div class="col-md-5 text-center">
              <div class="ftco-footer-widget mb-5">
                <ul class="ftco-footer-social list-unstyled">
                  <li><a href="https://twitter.com/ja_nakh"><span class="icon-twitter"></span></a></li>
                  <li><a href="https://www.facebook.com/chan.htut.5"><span class="icon-facebook"></span></a></li>
                  <li><a href="https://www.instagram.com/janakhpon/"><span class="icon-instagram"></span></a></li>
                </ul>
              </div>
              <div class="ftco-footer-widget">
                <h2 class="mb-3">Contact Me</h2>
                <p class="h3 email"><a href="#">minchanhtutoo@gmail.com</a></p>
              </div>
            </div>
          </div>
          <div class="row">
